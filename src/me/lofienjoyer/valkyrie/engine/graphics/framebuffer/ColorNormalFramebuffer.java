...
public class ColorNormalFramebuffer implements Framebuffer {

    private final int id, colorTextureId, normalTextureId, rboId;

    private int width, height;

    public ColorNormalFramebuffer(int width, int height) {
        this.id = glGenFramebuffers();
        bind();

        this.colorTextureId = glGenTextures();
        this.normalTextureId = glGenTextures();
